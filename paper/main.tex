...
Neary's superseded 2013 preprint~\cite{Neary13} announced the same numerical statement
through an abandoned four-pair PCP claim.  Thus Theorem~\ref{thm:main} is not the first
public statement of $\Mort_3(5)$.  No earlier valid proof of either theorem was found in our
literature search; any priority claim should remain qualified pending author review.
...
words.
arXiv:1312.6700v1, 2013.  Superseded claim.
