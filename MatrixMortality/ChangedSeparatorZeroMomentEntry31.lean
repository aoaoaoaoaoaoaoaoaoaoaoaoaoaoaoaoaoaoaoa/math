...
/-!
# Rank-nine zero-moment certificate, entry 31
...
/-- Entry (3, 1) of the chain chart's zeroth moment. -/
theorem chain_zero_moment_entry_three_one (ρ V K : ℚ)
    (regular : RegularChart ρ V K) :
    (chainOutput ρ V K * chainInput ρ V K) 3 1 = 1 := by
