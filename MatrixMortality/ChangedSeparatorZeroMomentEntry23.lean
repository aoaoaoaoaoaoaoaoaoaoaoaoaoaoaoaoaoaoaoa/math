...
/-!
# Rank-nine zero-moment certificate, entry 23
...
/-- Entry (2, 3) of the chain chart's zeroth moment. -/
theorem chain_zero_moment_entry_two_three (ρ V K : ℚ)
    (regular : RegularChart ρ V K) :
    (chainOutput ρ V K * chainInput ρ V K) 2 3 = 0 := by
