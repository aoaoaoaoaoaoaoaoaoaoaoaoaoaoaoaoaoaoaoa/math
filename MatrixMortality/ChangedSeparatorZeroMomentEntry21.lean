...
/-!
# Rank-nine zero-moment certificate, entry 21
...
/-- Entry (2, 1) of the chain chart's zeroth moment. -/
theorem chain_zero_moment_entry_two_one (ρ V K : ℚ)
    (regular : RegularChart ρ V K) :
    (chainOutput ρ V K * chainInput ρ V K) 2 1 = 0 := by
