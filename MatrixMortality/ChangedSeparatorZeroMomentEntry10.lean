...
/-!
# Rank-nine zero-moment certificate, entry 10
...
/-- Entry (1, 0) of the chain chart's zeroth moment. -/
theorem chain_zero_moment_entry_one_zero (ρ V K : ℚ)
    (regular : RegularChart ρ V K) :
    (chainOutput ρ V K * chainInput ρ V K) 1 0 = 0 := by
