...
/-!
# Rank-nine zero-moment certificate, entry 11
...
/-- Entry (1, 1) of the chain chart's zeroth moment. -/
theorem chain_zero_moment_entry_one_one (ρ V K : ℚ)
    (regular : RegularChart ρ V K) :
    (chainOutput ρ V K * chainInput ρ V K) 1 1 = 0 := by
