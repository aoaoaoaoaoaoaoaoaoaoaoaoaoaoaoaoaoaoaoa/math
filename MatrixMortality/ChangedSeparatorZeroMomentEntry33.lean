...
/-!
# Rank-nine zero-moment certificate, entry 33
...
/-- Entry (3, 3) of the chain chart's zeroth moment. -/
theorem chain_zero_moment_entry_three_three (ρ V K : ℚ)
    (regular : RegularChart ρ V K) :
    (chainOutput ρ V K * chainInput ρ V K) 3 3 = 0 := by
