...
The exact physical upper-code automaton from `MM-S105` applies to the arbitrary intercept (2).
Lean proves:
...
A direct replacement of the canonical `MM-S105` lower intercept bound is false. Exact
