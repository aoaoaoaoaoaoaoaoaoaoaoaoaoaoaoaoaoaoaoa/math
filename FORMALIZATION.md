...
| [`D2-O07`](SALVAGE.md#d2-o07-guarded-real-pole-reset) | exact normalized band coordinates, full deepest-branch depth reset, and an unbounded period-fifty reset family preserving the real and `5`-adic guards |
