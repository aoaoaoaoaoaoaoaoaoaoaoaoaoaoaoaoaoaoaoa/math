...
| `InverseOrbitRecurrence.lean` | exact integer-box cardinality, the finite bounded-prefix stabilizer horizon, and unbounded escape under trivial target stabilizer |
